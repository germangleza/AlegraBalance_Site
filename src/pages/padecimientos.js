  ...
  <div class="container">
    <div class="page-hero__grid">
      <div>
        ...
        ${C.scheduleBtn({ label: "Agendar valoración", loc: "padecimientos-hero" })}
      </div>
...
<section class="section bg-white" id="respiratorias">
  <div class="container">
...
<section class="section bg-turq" id="piel">
  <div class="container">
...
<section class="section bg-white" id="alimentarias">
  <div class="container">
    ...
    <div style="margin-top:1.5rem">${C.scheduleBtn({ label: "Solicitar valoración", loc: "alimentarias" })}</div>
  </div>
</section>
  ...
  <div class="container">
    <div class="duo">
      ...
      <div class="panel reveal" style="background:#fff">
        ...
        ${C.scheduleBtn({ label: "Solicitar consulta", loc: "oculares" })}
      </div>
    </div>
  </div>
</section>

<section class="section bg-white" id="pediatrica">
  <div class="container">
    <div class="feature">
      ...
      <div class="reveal">
        ...
        ${C.scheduleBtn({ label: "Agendar consulta pediátrica", loc: "pediatrica" })}
      </div>
    </div>
  </div>
</section>
