import { emergencyNoticeHtml, faqHtml } from "../lib/htmlBits.js";

const articlePage = (a) => a;
...
const article1 = articlePage({
  ...
  body: `
    ...
    ${emergencyNoticeHtml("Ante dificultad intensa para respirar, inflamación de lengua o garganta, desmayo o una reacción rápidamente progresiva, llama al <strong>911</strong> o acude a urgencias.")}
...
export const articulos = [article1, article2];
